  ...
  return (
    <div className="flex h-screen bg-slate-50 font-sans text-slate-900 overflow-hidden">
      ...
      <aside
        ...
        className="bg-white border-r border-slate-200 flex flex-col relative z-20 shadow-xl shadow-slate-200/50 transition-all duration-300"
      >
          ...
          {navItems.map((item) => (
            ...
            >
              ...
              {activeModule === item.id && isSidebarOpen && (
                <div className={`ml-auto w-1.5 h-6 rounded-full ${item.color.replace('text', 'bg')}`} />
              )}
            </button>
          ))}
        </nav>
